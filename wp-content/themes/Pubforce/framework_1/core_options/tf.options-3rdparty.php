...
function themeforce_3rdparty_overview_page() {
    ...
    <div class="wrap" id="tf-options-page">
        ...
        <p>By using plately, we help you <strong>eliminate input duplication</strong> as well as provide integrations to <strong>strong solutions</strong> in other areas of managing a restaurant, i.e. reservations, taking orders, etc.</p>
