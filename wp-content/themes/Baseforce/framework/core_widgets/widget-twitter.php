...
class tf_twitter_widget extends WP_Widget {
	...
	function widget( $args, $instance ) {
		...
		$account = ($instance['tf_twitter_account']) ? $instance['tf_twitter_account'] : '@happydinings';
		$instance['tf_twitter_account'] = $account;
    ...
    function form( $instance ) {
        $defaults = array( 'tf_twitter_title' => __('Twitter Feed', 'themeforce'), 'tf_twitter_account' => '@happydinings' , 'tf_twitter_count' => '5');
