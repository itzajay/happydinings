...
class tf_googlemaps_widget extends WP_Widget {
	...
	function tf_googlemaps_widget() {
		/* Widget settings. */
		$widget_ops = array( 'classname' => 'widget_google_maps', 'description' => __('This widget is used to show a Google Map of your business (based on your address in the options)', 'themeforce') );
		...
		/* Create the widget. */
		parent::WP_Widget( 'google_maps', __('Google Maps', 'example'), $widget_ops, $control_ops );
	}
	...
	function widget( $args, $instance ) {
		...
		$height = ($instance['gmaps-height']) ? $instance['gmaps-height'] : 250;
        $zoom = ($instance['gmaps-zoom']) ? $instance['gmaps-zoom'] : 5;
