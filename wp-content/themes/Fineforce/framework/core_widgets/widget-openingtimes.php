...
class tf_openingtimes_widget extends WP_Widget {
	...
	function tf_openingtimes_widget() {
		/* Widget settings. */
		$widget_ops = array( 'classname' => 'widget_openingtimes', 'description' => __('This widget is used to show Opening Times', 'themeforce') );
		...
		/* Create the widget. */
		parent::WP_Widget( 'openingtimes', __('Opening Times', 'example'), $widget_ops, $control_ops );
	}
